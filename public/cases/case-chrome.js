...
var a = class {
	...
	advance(e) {
		...
		} else this.lerp ? (this.value = r(this.value, this.to, this.lerp * 60, e), Math.round(this.value) === Math.round(this.to) && (this.value = this.to, n = !0)) : (this.value = this.to, n = !0);
...
var f = class {
	...
	onWheel = (e) => {
		let { deltaX: t, deltaY: n, deltaMode: r } = e, i = d(r, this.window.width), a = d(r, this.window.height);
...
}, p = (e) => Math.min(1, 1.001 - 2 ** (-10 * e)), m = class {
	_isScrolling = !1;
	_isStopped = !1;
	_isLocked = !1;
	...
	dimensions;
	virtualScroll;
	constructor({ wrapper: t = window, content: n = document.documentElement, eventsTarget: r = t, smoothWheel: i = !0, syncTouch: a = !1, syncTouchLerp: o = .075, touchInertiaExponent: c = 1.7, duration: l, easing: u, lerp: d = .1, infinite: m = !1, orientation: h = "vertical", gestureOrientation: g = h === "horizontal" ? "both" : "vertical", touchMultiplier: _ = 1, wheelMultiplier: v = 1, autoResize: y = !0, prevent: b, virtualScroll: x, overscroll: S = !0, autoRaf: C = !1, anchors: w = !1, autoToggle: T = !1, allowNestedScroll: E = !1, __experimental__naiveDimensions: D = !1, naiveDimensions: O = D, stopInertiaOnNavigate: k = !1 } = {}) {
		window.lenisVersion = e, window.lenis || (window.lenis = {}), window.lenis.version = e, h === "horizontal" && (window.lenis.horizontal = !0), a === !0 && (window.lenis.touch = !0), (!t || t === document.documentElement) && (t = window), typeof l == "number" && typeof u != "function" ? u = p : typeof u == "function" && typeof l != "number" && (l = 1), this.options = {
			wrapper: t,
			content: n,
			eventsTarget: r,
			smoothWheel: i,
	...
	scrollTo(e, { offset: n = 0, immediate: r = !1, lock: i = !1, programmatic: a = !0, lerp: o = a ? this.options.lerp : void 0, duration: s = a ? this.options.duration : void 0, easing: c = a ? this.options.easing : void 0, onStart: l, onComplete: u, force: d = !1, userData: f } = {}) {
		...
		if (typeof m == "number") {
			...
			a || (this.targetScroll = m), typeof s == "number" && typeof c != "function" ? c = p : typeof c == "function" && typeof s != "number" && (s = 1), this.animate.fromTo(this.animatedScroll, m, {
				duration: s,
				easing: c,
				lerp: o,
				onStart: () => {
...
function g() {
	...
	document.documentElement.classList.add("lenis"), document.body.classList.add("lenis"), window.addEventListener("beforeunload", () => {
		e.destroy();
	});
}
function _(e, t, n, r) {
...
function v() {
	...
	e.className = "case-cursor", e.setAttribute("aria-hidden", "true"), e.innerHTML = "<svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\"><line x1=\"12\" y1=\"0\" x2=\"12\" y2=\"9\" stroke=\"#fff\" stroke-width=\"1\"/><line x1=\"12\" y1=\"15\" x2=\"12\" y2=\"24\" stroke=\"#fff\" stroke-width=\"1\"/><line x1=\"0\" y1=\"12\" x2=\"9\" y2=\"12\" stroke=\"#fff\" stroke-width=\"1\"/><line x1=\"15\" y1=\"12\" x2=\"24\" y2=\"12\" stroke=\"#fff\" stroke-width=\"1\"/><circle cx=\"12\" cy=\"12\" r=\"2\" stroke=\"#fff\" stroke-width=\"1\" fill=\"none\"/></svg>", document.body.appendChild(e);
	let t = -100, n = -100, r = 0, i = 0, a = -100, o = -100, s = performance.now();
	window.addEventListener("mousemove", (e) => {
		a = e.clientX, o = e.clientY;
	});
	let c = (l) => {
		let u = Math.min((l - s) / 1e3, .064);
		s = l, [t, r] = _(t, a, r, u), [n, i] = _(n, o, i, u), e.style.transform = `translate3d(${t}px, ${n}px, 0) translate(-50%, -50%)`, requestAnimationFrame(c);
	};
